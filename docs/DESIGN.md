...
└── example-deployer-environments/  # Example environments directory
    ├── bootstrap/                  # Bootstrap module for IAM/S3
    ├── bootstrap-example/          # Example bootstrap instance
    ├── myapp-staging/              # Example standalone environment
    ├── shared-infra-staging/       # Example shared infrastructure
    └── app-on-shared-staging/      # Example app on shared infra
```
