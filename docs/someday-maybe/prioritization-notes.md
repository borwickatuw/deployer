+++
title = "Prioritization Notes"
+++

When considering implementation:

1. **High value, low effort**: ~~ECR vulnerability notifications, cost anomaly detection~~ (moved to [PLAN-ARCHIVE-2026-09.md](../PLAN-ARCHIVE-2026-09.md))
