...
- **7-4 — bin/link-environments.py — 72 statements at 17% (c4d9648), the smallest of the four. Sequence it with sub-phase 3-1 of the docs item: two of its ~/code/myapp example paths (:9 and the :48 Click docstring) are edited there, and a characterization test that asserts --help output would otherwise pin the wrong string.**
