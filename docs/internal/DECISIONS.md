...
**See also:** `modules/bootstrap/` for the policies themselves — the
2026-01-30 decision below moved them out of the static `iam-policies/` JSON
files this entry originally pointed at.
