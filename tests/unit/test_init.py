...
class TestListTemplates:
    ...
    def test_exactly_six_templates(self):
        templates = list_templates()
...
class TestReplaceHclBlock:
    """Tests for replace_hcl_block()."""

    def test_simple_replacement(self):
        content = "services = {\n  web = {}\n}\n\nscaling = {}"
        result = replace_hcl_block(content, "services", "services = {\n  api = {}\n}")
    ...
    def test_nested_braces(self):
        ...
        new = "services = {\n  api = {\n    cpu = 1024\n  }\n}"
        result = replace_hcl_block(content, "services", new)
        assert "api" in result
        assert "web" not in result
    ...
    def test_block_not_found(self):
        with pytest.raises(ValueError, match="Block 'missing' not found"):
            replace_hcl_block("services = {}", "missing", "new = {}")
    ...
    def test_empty_block(self):
        content = "scaling = {}"
        result = replace_hcl_block(content, "scaling", "scaling = {\n  web = {}\n}")
