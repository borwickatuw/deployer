...
def get_migrations_hash_param_name(app_name: str, environment: str) -> str:
...
def get_stored_migrations_hash(app_name: str, environment: str) -> str | None:
    ...
    """
    param_name = get_migrations_hash_param_name(app_name, environment)
...
def should_skip_migrations(
    ...
    if stored_hash is None:
        ...
        log(f"No stored migrations hash found, will run migrations")
