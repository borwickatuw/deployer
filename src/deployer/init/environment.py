...
example-deployer-environments/templates/.
...
def _apply_deploy_toml_services(
    ...
    updated = replace_hcl_block(target_content, "services", new_block)
...
def update_services(
    ...
    # Replace
    updated = replace_hcl_block(content, "services", new_block)
